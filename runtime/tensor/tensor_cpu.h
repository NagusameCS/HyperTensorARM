...
/* Matrix multiply: C[MN] = A[MK] * B[KN] — tiled SSE2 */
...
/* Conv2D: out[OHOWOC] = im2col(in)  W via GEMM
...
/* Winograd F(2,3) convolution — 2.25x fewer multiplications for 33 filters.
 ...
 *   out[seqd] = softmax(Q[seqd] · K^T[dseq] / sqrt(d)) · V[seqd] */
