...
| E2E: GGUF → compress (FFN+int4) → GGUF → ARM runtime | ✅ **Verified vs oracle**: exported GGUF runs on geodessical (10.8 tok/s, coherent) AND llama.cpp; PPL 10.98 vs llama.cpp 10.66 on same file; logits match a PyTorch dense reconstruction; tokenizer bit-identical to llama.cpp |
