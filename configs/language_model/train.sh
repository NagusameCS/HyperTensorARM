...
#!/bin/bash
# Dedicated Language Model Training
# Generated by scripts/train_dedicated_models.py

set -euo pipefail

MODEL="HuggingFaceTB/SmolLM2-135M"
OUTPUT="smollm2-135m-language-only"
EPOCHS=3
BATCH_SIZE=8
GRAD_ACCUM=4
MAX_STEPS=50000
...
echo "Config: Dedicated Language Model --- trained exclusively on natural language data"

# Use Axolotl or direct HF Trainer
# Option 1: Axolotl (recommended for efficient training)
# axolotl train configs/smollm2-135m-language-only.yml
...
python -m torch.distributed.run --nproc_per_node=1 scripts/train_single_skill.py \
    ...
    --save_steps 5000 \
    --logging_steps 100 \
    --dataset_config "configs\language_model\dataset_config.json"
