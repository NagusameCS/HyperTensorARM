...
| E2E: GGUF → compress (FFN SVD + int4) → GGUF → ARM runtime | OK **Verified vs oracle**: exports run on geodessical AND llama.cpp; tokenizer bit-identical to llama.cpp. Configs (0.5B, WikiText PPL ours / llama.cpp): int4-only 10.98 / 10.66; ffn_rank=1024+int4 14.89 / 14.20 (in-memory) and 11.66 / 11.09 (streaming, 861 MB). Decode: fp16 37.7 tok/s → Q8_0 108.7 / Q4_K_M 109.2 tok/s |
