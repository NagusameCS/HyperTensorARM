#!/usr/bin/env python3
"""HyperTensor ARM end-to-end CLI.

Compress and export GGUF models, either fully in memory or in a single
streaming pass, and verify outputs with the built-in geodessical runtime.
...
def cmd_verify(args: argparse.Namespace) -> int:
    ...
    r = subprocess.run([str(GEODESSICAL), model, "--ppl-eval"], capture_output=True, text=True)
